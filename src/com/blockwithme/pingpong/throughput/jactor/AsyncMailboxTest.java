    ...
    public void testTiming() {
        if (RUN) {
            ...
            try {
                ...
                int i = 0;
                while (i < actors) {
                    final Mailbox echoMailbox = mailboxFactory
                            .createAsyncMailbox();
                    ...
                    final Mailbox senderMailbox = mailboxFactory
                            .createAsyncMailbox();
                    final JLPCActor s = (buffer == 1) ? new Sender1(echo,
                            count, buffer) : new Sender(echo, count, buffer);
